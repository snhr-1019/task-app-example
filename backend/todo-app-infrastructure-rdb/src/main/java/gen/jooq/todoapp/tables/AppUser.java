...
public class AppUser extends TableImpl<AppUserRecord> {
    ...
    /**
     * The reference instance of <code>todoapp.app_user</code>
     */
    ...
    /**
     * The column <code>todoapp.app_user.uuid</code>.
     */
    public final TableField<AppUserRecord, String> UUID = createField(DSL.name("uuid"), SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>todoapp.app_user.username</code>.
     */
    public final TableField<AppUserRecord, String> USERNAME = createField(DSL.name("username"), SQLDataType.VARCHAR(32).nullable(false), this, "");

    /**
     * The column <code>todoapp.app_user.password</code>.
     */
    ...
    /**
     * Create an aliased <code>todoapp.app_user</code> table reference
     */
    ...
    /**
     * Create a <code>todoapp.app_user</code> table reference
     */
    public AppUser() {
    ...
    public List<UniqueKey<AppUserRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.KEY_APP_USER_APP_USER_PK);
    }
